...
4. Si al completar las veinte algún conjunto de control quedara vacío, se elicitan conversaciones adicionales con tarjetas que lo llenen, como prevé la §5.2 para las conversaciones que no sirven.
