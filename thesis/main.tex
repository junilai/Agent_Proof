...
\newcommand{\tituloObtenido}{Ingeniero en Ciencias de la Computación}
\newcommand{\nombreTutor}{Ricardo Flores Moyano, Ph.D.}
...
\input{capitulos/04-prototipo}
\input{capitulos/05-diseno-experimental}
